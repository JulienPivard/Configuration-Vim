...
syntax region adaWith
            ...
            \ end="\(;\|\<is\>\)"
            \ transparent keepend
            \ contains=adaAttribute,adaAspect,adaMotClef,adaOperateur,adaNombres,adaSpecial,adaBooleens,adaString,adaSpark,adaConditional,adaComment,adaBoucle,adaBuiltinType,adaCharacter
