...
"
for Item in ['Abstract_State', 'All_Calls_Remote', 'Assert', 'Assertion_Policy', 'Asynchronous', 'Atomic', 'Atomic_Components', 'Attach_Handler', 'Constant_Indexing', 'Controlled', 'Convention', 'Default_Iterator', 'Depends', 'Detect_Blocking', 'Discard_Names', 'Elaborate', 'Elaborate_All', 'Elaborate_Body', 'External_Name', 'Export', 'Ghost', 'Global', 'Implicit_Dereference', 'Import', 'Initializes', 'Inline', 'Inspection_Point', 'Iterator_Element', 'Interrupt_Handler', 'Interrupt_Priority', 'Linker_Options', 'List', 'Locking_Policy', 'No_Return', 'Normalize_Scalars', 'Optimize', 'Pack', 'Page', 'Part_Of', 'Partition_Elaboration_Policy', 'Post', 'Pre', 'Preelaborable_Initialization', 'Preelaborate', 'Priority', 'Priority_Specific_Dispatching', 'Profile', 'Pure', 'Queueing_Policy', 'Refined_State', 'Relative_Deadline', 'Remote_Call_Interface', 'Remote_Types', 'Restrictions', 'Reviewable', 'Shared_Passive', 'Spark_Mode', 'Storage_Size', 'Suppress', 'Task_Dispatching_Policy', 'Unchecked_Union', 'Unsuppress', 'Variable_Indexing', 'Volatile', 'Volatile_Components']
    let g:ada#Keywords += [{
	    \ 'word':  Item,
	    \ 'menu':  'pragma',
	    \ 'info':  'Ada pragma.',
